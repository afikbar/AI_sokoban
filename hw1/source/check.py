...
def main():
    ...
    #         (99, 99, 99, 20, 99, 99, 99),
    #         (99, 99, 99, 15, 99, 99, 99),
    #         (99, 20, 15, 17, 15, 20, 99),
    #         (99, 99, 99, 15, 99, 99, 99),
    #         (99, 99, 99, 20, 99, 99, 99),
    #         (99, 99, 99, 99, 99, 99, 99),
    #
    ...
    #     (
    #         (99, 99, 99, 99, 99, 99, 99),
    #         (99, 99, 20, 30, 10, 10, 99),
    #         (99, 17, 15, 30, 10, 10, 99),
    #         (99, 99, 99, 10, 10, 99, 99),
    #         (99, 99, 99, 99, 99, 99, 99),
    #     ),
    #
    #     (
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #         (99, 20, 20, 20, 20, 99, 99, 99, 99),
    #         (99, 10, 10, 15, 99, 99, 10, 10, 99),
    #         (99, 10, 15, 15, 10, 10, 10, 10, 99),
    #         (99, 17, 15, 10, 99, 10, 10, 10, 99),
    #         (99, 99, 10, 10, 99, 99, 99, 99, 99),
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #     ),
    #
    #     (
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99, 99),
    #         (99, 17, 10, 10, 99, 99, 10, 10, 20, 99),
    #         (99, 10, 10, 15, 10, 10, 10, 10, 20, 99),
    #         (99, 10, 15, 15, 99, 99, 99, 10, 20, 99),
    #         (99, 10, 10, 10, 10, 10, 10, 10, 99, 99),
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99, 99),
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99, 99),
    #     ),
    #
    #     (
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #         (99, 20, 30, 30, 30, 30, 15, 17, 99),
    #         (99, 10, 10, 10, 10, 10, 10, 10, 99),
    #         (99, 10, 10, 10, 10, 10, 10, 10, 99),
    #         (99, 10, 10, 15, 20, 10, 10, 15, 99),
    #         (99, 10, 10, 10, 10, 10, 10, 20, 99),
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #     ),
    #
    #     (
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #         (99, 10, 10, 10, 99, 10, 99, 10, 99),
    #         (99, 20, 15, 10, 30, 10, 99, 10, 99),
    #         (99, 20, 30, 10, 99, 10, 10, 10, 99),
    #         (99, 10, 10, 10, 99, 99, 30, 10, 99),
    #         (99, 10, 10, 10, 99, 10, 30, 17, 99),
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #     ),
    #
    #     (
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #         (99, 10, 20, 15, 10, 10, 10, 10, 99),
    #         (99, 10, 20, 15, 10, 10, 10, 10, 99),
    #         (99, 20, 20, 15, 10, 10, 10, 10, 99),
    #         (99, 10, 20, 15, 10, 10, 10, 10, 99),
    #         (99, 10, 20, 15, 10, 10, 10, 17, 99),
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #     ),
    #
    #     (
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #         (99, 10, 10, 30, 99, 10, 10, 10, 99),
    #         (99, 10, 99, 30, 99, 10, 15, 20, 99),
    #         (99, 10, 99, 30, 99, 10, 10, 10, 99),
    #         (99, 15, 99, 30, 99, 10, 99, 10, 99),
    #         (99, 20, 99, 10, 10, 10, 99, 17, 99),
    #         (99, 99, 99, 99, 99, 99, 99, 99, 99),
    #     ),
    #
    # ]
